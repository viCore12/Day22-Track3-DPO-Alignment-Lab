...
def run_lm_eval(adapter_path, tasks, limit, num_fewshot, label):
    ...
    # Use 16-bit base models. HuggingFace's native AutoModel (used by lm_eval) 
    # produces garbage/NaNs if fed an Unsloth 4-bit quantized model directly.
    base = "unsloth/Qwen2.5-3B" if COMPUTE_TIER == "T4" else "unsloth/Qwen2.5-7B"
